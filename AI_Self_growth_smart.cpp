...
int main() {
	...
	printf("Last modified: 2018-May29, Version: Smart 1.0\n");
...
//	}
//	printf("**********************************\n");
	const u64 threshold=  MAX_SITUATION>>6;
...
//
					...
					for(int i=0; i<candidate_number; i++) {
						...
						float t_score_1=(game_table[(u32)(z_hash_temp_value)].hash_code==0)?INITIAL_SCORE: game_table[(u32)(z_hash_temp_value)].score[current_turn];
						t_sum+=t_score_1;
