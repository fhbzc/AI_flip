...
//	printf("**********************************\n");
	...
	if(f_z) {
		...
		while(1) {
			...
			game_table[index_game_table].score[WHITE]=temp.score[WHITE];
			game_table[index_game_table].score[BLACK]=temp.score[BLACK];
